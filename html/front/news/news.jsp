...
<body>
	...
	<div id="content" style="width:800px;height:500px;position:absolute;top:0;left:135px;">
         <iframe width="100%" height="100%" frameborder="0" scrolling="no" class="" src="" name="content" id="newscontent">
 		...
 		$(function(){
			$("#navigation li").mouseover(function(){
			 ...
			 //$("#league").on('click',function(){
				...
				var content = "<p>蜂蜜是我们日常生活中经常会吃到的食品。</p><p>它营养丰富，具有增强抵抗力，减肥，促进消化和吸收等功效。长期服用不仅能够强身健体还能美容养颜，是爱美、爱健康人士必不可少的滋补佳品。</p><p>在食用蜂蜜的过程中我们肯定也听别人说过“蜂蜜一万年也不会变质”的说法 ，意思是蜂蜜可以保持很久基本不会腐坏变质。</p><p>那么事实真的是这样吗？蜂蜜为什么不会变质呢，下面我们一起来看看吧。</p>"
				...
				var url=projectName+"/community/newscontent.action?head="+head+"&id="+id+"&collegeId=1&title="+title+"&content="+content;
				console.log(url);		       

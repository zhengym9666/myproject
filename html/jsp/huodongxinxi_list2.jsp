...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>活动编号</td><td bgcolor='#CCFFFF'>活动名称</td><td bgcolor='#CCFFFF'>活动主题</td><td bgcolor='#CCFFFF'>负责人</td><td bgcolor='#CCFFFF'>主办单位</td><td bgcolor='#CCFFFF'>承办单位</td><td bgcolor='#CCFFFF'>活动日期</td><td bgcolor='#CCFFFF'>物品借用</td><td bgcolor='#CCFFFF'>社团</td><td bgcolor='#CCFFFF'>备注</td>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="huodongxinxi_list2.jsp?page=1">首页</a>　<a href="huodongxinxi_list2.jsp?page=<%= curpage-1%>">上一页</a>　<A href="huodongxinxi_list2.jsp?page=<%= curpage+1%>">下一页</A>　<a href="huodongxinxi_list2.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>

...
%>
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='jiaruhuodong_listxls.jsp';" />
</form>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="jiaruhuodong_list.jsp?page=1">首页</a>　<a href="jiaruhuodong_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="jiaruhuodong_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="jiaruhuodong_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>

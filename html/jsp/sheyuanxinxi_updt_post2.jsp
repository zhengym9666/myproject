...
String sql="update sheyuanxinxi set xuehao='"+xuehao+"',xingming='"+xingming+"',mima='"+mima+"',zhuanye='"+zhuanye+"',banji='"+banji+"',sushe='"+sushe+"',lianxifangshi='"+lianxifangshi+"',zhaopian='"+zhaopian+"',beizhu='"+beizhu+"',shetuan='"+shetuan+"',shifoushechang='"+shifoushechang+"' where xuehao= '"+request.getSession().getAttribute("username")+"'";
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='sheyuanxinxi_updt2.jsp';</script>");
%>
  </body>
</html>

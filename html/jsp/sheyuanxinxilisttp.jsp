...
<table width="1002" height="1176" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
   ...
   搜索: 学号：<input name="xuehao" type="text" id="xuehao" style='border:solid 1px #000000; color:#666666' size="12" /> 姓名：<input name="xingming" type="text" id="xingming" style='border:solid 1px #000000; color:#666666' size="12" />
     <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit5" value="切换视图"  style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='sheyuanxinxilist.jsp';" />
</form>
				...
				String fysql="select count(id) as ss from sheyuanxinxi where issh='是'";
  ...
  zys=zgs/page_record+1;
   ...
   sql="";
  sql="select top "+page_record+" * from sheyuanxinxi where issh='是' and id not in (select top "+((curpage-1)*page_record)+" id from sheyuanxinxi where issh='是' order by id desc) ";
...
xuehao=RS_result.getString("xuehao");xingming=RS_result.getString("xingming");mima=RS_result.getString("mima");zhuanye=RS_result.getString("zhuanye");banji=RS_result.getString("banji");sushe=RS_result.getString("sushe");lianxifangshi=RS_result.getString("lianxifangshi");zhaopian=RS_result.getString("zhaopian");beizhu=RS_result.getString("beizhu");shetuan=RS_result.getString("shetuan");shifoushechang=RS_result.getString("shifoushechang");issh=RS_result.getString("issh");
 addtime=RS_result.getString("addtime");
				  ...
				  %>
						...
						<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="sheyuanxinxilisttp.jsp?page=1">首页</a>　<a href="sheyuanxinxilisttp.jsp?page=<%= curpage-1%>">上一页</a>　<A href="sheyuanxinxilisttp.jsp?page=<%= curpage+1%>">下一页</A>　<a href="sheyuanxinxilisttp.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>

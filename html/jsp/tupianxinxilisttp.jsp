...
<table width="1002" height="1176" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
                ...
                <td valign="top"><table id="__01" width="738" height="225" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="738" height="41" background="qtimages/1_02_01_02_01.gif"><table width="100%" height="18" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="24%" align="center" valign="bottom"><span class="STYLE3">图片信息</span></td>
   ...
   搜索: 图片名称：<input name="tupianmingcheng" type="text" id="tupianmingcheng" style='border:solid 1px #000000; color:#666666' size="12" />
     <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit5" value="切换视图"  style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='tupianxinxilist.jsp';" />
</form>
 ...
 addtime=RS_result.getString("addtime");
				  ...
				  %>
                            <td align="center"><table width="150" height="153" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="126" align="center"><a href="<%=tupian%>" target="_blank"><img src="<%=tupian%>" width="109" height="126" border="0" /></a></td>
                                </tr>
                                <tr>
                                  <td height="26" align="center"><%=tupianmingcheng%></td>
                                </tr>
                            </table></td>
                            <%
								if (i==4)
				  ...
				  %>
						...
						<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="tupianxinxilisttp.jsp?page=1">首页</a>　<a href="tupianxinxilisttp.jsp?page=<%= curpage-1%>">上一页</a>　<A href="tupianxinxilisttp.jsp?page=<%= curpage+1%>">下一页</A>　<a href="tupianxinxilisttp.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>

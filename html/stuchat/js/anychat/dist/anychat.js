    ...
    var UserObj = function () {
        ...
        this.createView = function () {
            ...
            if (this.user.userImg === null || this.user.userImg === undefined) {
                img = projectName+"/stuchat/js/anychat/images/default.png";
            } else {
...
(function (window) {
    ...
    var GroupObj = function () {
        ...
        this.createView = function () {
            ...
            view.innerHTML = '<img src="../../stuchat/js/anychat/images/groupIcon.png" alt=""/><span class="titleSty2_P">' + this.group.chatGroupName + '</span>';
            this.view = $(view);
        };
        this.addOptListener = function () {
            this.addClickListener(this, this.onClick);
...
(function (window) {
    ...
    var TalkMediator = function () {
        ...
        this.createOtherUserChat = function (chat) {
            //把文字符号转换为img标签
            var chatContent=this.replace_emToHtml(chat.chatContent);
        ...
        this.onSendChat = function (event) {
            ...
            //$("#sendChatContent").val();
            chatContent=this.replace_htmlToEm(chatContent);
